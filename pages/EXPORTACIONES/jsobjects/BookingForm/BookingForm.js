export default {
  ...
  resetMainWidgets() {
    [
      ...
      "dp_pick_up_sea",
      "dp_consolidacion_sea",
      "dp_cierre_fisico_lcl",
      "dp_eta_origen_sea",
      "dp_etd_sea",
      "dp_eta_destino_sea",
      "inp_bultos_sea",
      "sl_embalaje_sea",
      "inp_peso_neto_kg_sea",
      "inp_peso_bruto_kg_sea",
      "inp_medidas_sea",
      "inp_cbm_sea",
      "rd_remontable_sea",
      "sl_buque_lcl",
      ...
      "dp_pick_up_air",
      "dp_cierre_documental_air",
      "dp_cierre_fisico_air",
      "dp_etd_air",
      "dp_eta_air",
      "inp_bultos_air",
      "sl_embalaje_air",
      "inp_peso_neto_kg_air",
      "inp_peso_bruto_kg_air",
      "inp_medidas_air",
      "inp_cbm_air",
      "rd_remontable_air",

      "sl_transporte_nacional_ter",
      "inp_total_vehiculos_ter",
      "sl_tipo_vehiculo_ter",
      "dt_cargue_ter",
      "sl_manejo_frontera_ter",
      "sl_deposito_en_frontera_ter",
      "dt_ingreso_deposito_ter",
      "inp_factura_triangulacion_ter",
      "dt_fecha_factura_ter",

      "dp_pick_up_correo",
      "dp_eta_correo",
      "sl_courier_correo",
      "sl_cuenta_courier_correo",
      "inp_awb_correo",
      "inp_bultos_correo",
      "sl_embalaje_correo",
      "inp_peso_neto_kg_correo",
      "inp_peso_bruto_kg_correo",
      "inp_medidas_correo",
      "inp_cbm_correo"
    ].forEach((w) => {
      try {
